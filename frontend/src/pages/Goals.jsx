...
function Goals() {
  ...
  const [goals, setGoals] = useState([
    { id: 1, name: "Emergency Fund", desc: "Safety net for 6 months of expenses", target: 50000, saved: 20000, icon: "savings", status: "active" },
    { id: 2, name: "Summer Vacation", desc: "Trip to Boracay", target: 30000, saved: 12000, icon: "flight", status: "active" },
    { id: 3, name: "New Car", desc: "Down payment fund", target: 150000, saved: 25000, icon: "car", status: "paused" },
  ]);
              ...
              <div className="col-span-2 space-y-6">
                {featured && (
                  <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-[#e5eeff] dark:border-gray-700">
                    <div className="flex items-start justify-between mb-6">
                      ...
                      <button onClick={() => handleDelete(featured.id)} className="text-gray-300 hover:text-red-500 transition">
                        <MdDelete size={20} />
                      </button>
                    </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  {rest.map((g) => {
                    ...
                    return (
                      <div key={g.id} className="bg-white dark:bg-gray-800 rounded-2xl p-5 border border-[#e5eeff] dark:border-gray-700">
                        <div className="flex items-center justify-between mb-3">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <button onClick={() => handleDelete(g.id)} className="text-gray-300 hover:text-red-500 transition">
                              <MdDelete size={16} />
                            </button>
                          </div>
                        </div>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-[#4648d4] rounded-2xl p-6 text-white">
                  ...
                  <p className="text-sm text-indigo-200 mb-4 leading-relaxed">
                    You're making great progress! Keep your savings consistent to reach your goals faster.
                  </p>
