...
import {
  ...
  MdReceipt, MdAdd, MdNotifications, MdSearch,
} from "react-icons/md";
...
function Dashboard() {
  ...
  const handleEditClick = (transaction) => {
    ...
    setEditForm({ type: transaction.type, amount: transaction.amount, category: transaction.category, accountType: transaction.accountType });
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="flex items-center justify-between px-8 py-4 bg-white dark:bg-gray-900 border-b border-[#e5eeff] dark:border-gray-700 flex-shrink-0">
          ...
          <div className="flex items-center gap-3">
            ...
            <button className="w-10 h-10 flex items-center justify-center text-gray-500 hover:bg-[#eff4ff] dark:hover:bg-gray-800 rounded-full relative transition-all">
        ...
        <div className="flex-1 overflow-y-auto p-8">
          ...
          <div className="grid grid-cols-3 gap-6 mb-6">
            <div className="col-span-2 bg-gray-900 dark:bg-gray-800 rounded-2xl p-8 text-white relative overflow-hidden">
              ...
              <div className="relative z-10">
                <h2 className="text-3xl font-bold mb-2 font-[Plus_Jakarta_Sans]">Welcome back, {name} 👋</h2>
                <p className="text-gray-400 text-sm mb-6">Here's your financial overview for this period.</p>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-[#e5eeff] dark:border-gray-700 flex flex-col justify-between">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-xs font-semibold text-green-500 bg-green-50 dark:bg-green-900/30 px-2 py-1 rounded-full">Active</span>
              </div>
              <div>
          ...
          <div className="grid grid-cols-2 gap-6 mb-6">
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-[#e5eeff] dark:border-gray-700">
              ...
              <p className="text-3xl font-bold text-gray-900 dark:text-white font-[Plus_Jakarta_Sans]">₱{income.toLocaleString()}</p>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-[#e5eeff] dark:border-gray-700">
              ...
              <p className="text-3xl font-bold text-gray-900 dark:text-white font-[Plus_Jakarta_Sans]">₱{expenses.toLocaleString()}</p>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl border border-[#e5eeff] dark:border-gray-700">
            <div className="flex items-center justify-between p-6 border-b border-[#e5eeff] dark:border-gray-700">
              <div>
                ...
                <p className="text-xs text-gray-400 mt-0.5">Last {Math.min(5, transactions.length)} entries</p>
              </div>
              <button
            ...
            {transactions.length === 0 ? (
              ...
              transactions.slice(0, 5).map((t) => (
                <div key={t._id} className="grid grid-cols-5 items-center px-6 py-4 border-b dark:border-gray-700 last:border-none hover:bg-[#f8f9ff] dark:hover:bg-gray-750 transition-colors">
                  <div className="flex items-center gap-3">
                  ...
                  <span>
                    <span className={`text-xs font-semibold px-2.5 py-1 rounded-full ${t.type === "income" ? "bg-green-50 dark:bg-green-900/30 text-green-600" : "bg-red-50 dark:bg-red-900/30 text-red-500"}`}>
                  ...
                  <div className="flex gap-2">
                    <button onClick={() => handleEditClick(t)} className="text-xs bg-[#eff4ff] dark:bg-gray-700 text-[#4648d4] dark:text-indigo-400 px-3 py-1.5 rounded-lg hover:bg-[#e5eeff] dark:hover:bg-gray-600 transition font-semibold">
                      Edit
                    </button>
                    <button onClick={() => handleDelete(t._id)} className="text-xs bg-red-50 dark:bg-red-900/20 text-red-500 px-3 py-1.5 rounded-lg hover:bg-red-100 dark:hover:bg-red-900/30 transition font-semibold">
                      Delete
                    </button>
                  </div>
                </div>
        ...
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-8 w-full max-w-md relative shadow-2xl border border-[#e5eeff] dark:border-gray-700">
            ...
            <div className="space-y-4">
              ...
              <button onClick={handleUpdate} className="w-full bg-[#4648d4] hover:bg-[#3a3cb8] text-white py-3 rounded-lg font-semibold transition">
                Save Changes
              </button>
            </div>
          </div>
